    ...
    display.FULL_DISPLAY_SCHEMA.extend(
        {
            ...
            cv.Required(CONF_GMOD_PIN): pins.internal_gpio_output_pin_schema,
            cv.Required(CONF_GPIO0_ENABLE_PIN): pins.internal_gpio_output_pin_schema,
            cv.Required(CONF_OE_PIN): pins.internal_gpio_output_pin_schema,
            cv.Required(CONF_POWERUP_PIN): pins.internal_gpio_output_pin_schema,
            cv.Required(CONF_SPV_PIN): pins.internal_gpio_output_pin_schema,
            cv.Required(CONF_VCOM_PIN): pins.internal_gpio_output_pin_schema,
            cv.Required(CONF_WAKEUP_PIN): pins.internal_gpio_output_pin_schema,
